...
class QDDETRPredictor:
    ...
    def localize_moment(self, video_path, query_list):
        ...
        # assert n_frames <= 75 # "The positional embedding of this pretrained QDDETR only support video up " "to 150 secs (i.e., 75 2-sec clips) in length"
        ...
        print("video_feats.shape", video_feats.shape, "query_feats.shape", query_feats, "video_mask.shape", video_mask.shape, "query_mask.shape", query_mask.shape,query_list)
        model_inputs = dict(
            src_vid=video_feats,
        ...
        print("saliency_scores", _saliency_scores.shape)
        saliency_scores = []
