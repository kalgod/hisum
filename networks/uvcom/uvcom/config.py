...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--lr_drop", default=[70], type=int, nargs='+', help="drop learning rate to 1/10 every lr_drop epochs")
        parser.add_argument("--lr_gamma", default=0.5, type=float, help="drop learning rate to 1/10 every lr_drop epochs")
        ...
        parser.add_argument('--neg_loss_coef', default=1, type=float)
        parser.add_argument('--neg_choose_epoch', default=100, type=float)
        parser.add_argument('--em_iter', default=5, type=int)
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['uvcom/model.py', 'uvcom/CIM.py']
